...
<title>Operational Letters</title>
...
<body>
    ...
    <script>
		...
		$(document).ready(function() {
			...
			$("#showResultsId").load("letterSearchLoad.php?type=operational");
            ...
            $.ajax({
                ...
                success: function(e) {
                    if(e.indexOf("success") != -1) {
                        ...
                        window.location = "letterOperational.php";
                    }
                ...
                $.get(
                    ...
                    function(output) {
						...
						for(i=0; i<searchArr.length; i++) {
							...
							anchorElement.setAttribute("href", "uploads/" + searchArr[i].file_name)
