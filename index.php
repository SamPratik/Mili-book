...
<?php
	...
	$hits = "UPDATE hit_counter SET hitcount = hitcount + 1 WHERE id=1";
	mysqli_query($connection,$hits);
    ...
    <div class="container-fluid row book slide-anim" style="padding:80px 100px;">
        ...
        <div class="carousel slide col-md-8" data-ride="carousel" data-type="multi" data-interval="2000" id="fruitscarousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="Admin/book cover images/img1.jpg" class="col-md-3 col-sm-4 col-xs-12">
                </div>
                <div class="item">
                    <img src="Admin/book cover images/img2.jpg" class="col-md-3 col-sm-4 col-xs-12">
                </div>
                <div class="item">
                    <img src="Admin/book cover images/img3.jpg" class="col-md-3 col-sm-4 col-xs-12">
                </div>
                <div class="item">
                    <img src="Admin/book cover images/img4.jpg" class="col-md-3 col-sm-4 col-xs-12">
                </div>
                <div class="item">
                    <img src="Admin/book cover images/img5.jpg" class="col-md-3 col-sm-4 col-xs-12">
                </div>
                <div class="item">
                    <img src="Admin/book cover images/img6.jpg" class="col-md-3 col-sm-4 col-xs-12">
                </div>
            </div>
