    ...
    <div class="content">
        ...
        <div class="container"><br/>
            ...
            <form>
                ...
                <button id="postBtnId" type="button" class="btn btn-success pull-right" onClick="postSubmit('<?php echo $_SESSION["name"]; ?>',<?php echo $_SESSION["id"]; ?>)">Submit</button>
            </form><br/><br/>
            <!-----------END: Post Form----------->
            ...
            <div id="deletePostId<?php echo $RowPost['id']; ?>" class="media" style="box-shadow:0px 0px 1px black; padding:32px; border-radius:8px;">
                ...
                <div class="media-body">
                    ...
                    <span class="pull-right">
                        ...
                        <?php if($_SESSION["id"] == $RowPost["user_id"]) { ?>
                    ...
                    <div class="comments" id="commentId<?php echo $RowPost['id']; ?>">
                        ...
                        <form id="commentFormId<?php echo $RowPost['id']; ?>">
                            ...
                            <button id="commentBtnId" type="button" class="btn btn-primary btn-xs pull-right" onClick="commentSubmit(<?php echo $RowPost['id']; ?>,'<?php echo $_SESSION["name"]; ?>',<?php echo $_SESSION["id"]; ?>)">Comment</button>
                        </form>
